...
export default function Profile() {
  ...
  useEffect(() => {
    if (nfts.data && nfts.data.length > 0) {
      setActiveNft(nfts.data[nfts.data.length - 1]);
    }
              ...
              <div className="pb-16 space-y-6">
                ...
                <div className="flex">
                  ...
                  <button
                    ...
                    type="button"
                    className="disabled:bg-green-400 disabled:cursor-not-allowed flex-1 ml-3 bg-green-700 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  >
